...
export const metadata: Metadata = {
  title: "Checkout",
  description: "Buat order Zynex Studio dan lanjutkan konfirmasi pesanan via WhatsApp.",
    ...
    <div className="container-page py-10 sm:py-14">
      <header className="mb-8">
        ...
        <p className="mt-2 text-[15px] text-white/55">
          Isi data pemesan, buat order, lalu lanjutkan konfirmasi via WhatsApp admin.
        </p>
      </header>
